...
{
    internal class ServerForceFallStateNetworkRequest : INetMessage
    {
        NetworkInstanceId netID;

        public ServerForceFallStateNetworkRequest()
        {

        }

        public ServerForceFallStateNetworkRequest(NetworkInstanceId netID)
        {
            this.netID = netID;
        }
        ...
        public void ForceFallState()
        {
            ...
            foreach (EntityStateMachine stateMachine in stateMachines)
            {
                ...
                {
                    stateMachine.SetState(new MasterSwordLandingExit());
                    return;
                }
            }
        }
