...
{
    internal class ServerForceDownstabRecoveryNetworkRequest : INetMessage
    {
        NetworkInstanceId netID;

        public ServerForceDownstabRecoveryNetworkRequest()
        {

        }

        public ServerForceDownstabRecoveryNetworkRequest(NetworkInstanceId netID)
        {
            this.netID = netID;
        }
        ...
        public void ForceFallState()
        {
            ...
            foreach (EntityStateMachine stateMachine in stateMachines)
            {
                ...
                {
                    stateMachine.SetState(new MasterSwordAerialDownstabRecovery());
                    return;
                }
            }
        }
