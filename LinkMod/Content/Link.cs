    ...
    internal class MyCharacter : SurvivorBase
    {
        ...
        public override CustomRendererInfo[] customRendererInfos { get; set; } = new CustomRendererInfo[] 
        {
                new CustomRendererInfo
                {
                    ...
                    material = Materials.CreateHopooMaterial("matLink"),
                },
                new CustomRendererInfo
                {
                    childName = "GunModel",
        ...
        public override void InitializeSkills()
        {
            ...
            SkillDef primarySkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo(prefix + "_LINK_BODY_PRIMARY_SLASH_NAME",
        ...
        public override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(LinkPlugin.DEVELOPER_PREFIX + "_LINK_BODY_DEFAULT_SKIN_NAME",
            ...
            defaultSkin.meshReplacements = new SkinDef.MeshReplacement[]
            {
                ...
                //{
                //    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshLinkSword"),
                //    renderer = defaultRenderers[0].renderer
                //},
                //new SkinDef.MeshReplacement
                //{
                //    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshLinkGun"),
                //    renderer = defaultRenderers[1].renderer
                //},
                //new SkinDef.MeshReplacement
                //{
                //    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshLink"),
